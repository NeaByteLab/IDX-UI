...
export function useMarketIndices(params?: Types.PaginationParams): Types.UseMarketIndicesResult {
  ...
  useEffect(() => {
    ...
    API.apiGet<Types.PaginatedResponse<unknown>>(API.marketIndicesPath(), query)
      .then((res) => {
