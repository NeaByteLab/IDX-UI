...
export function useMarketIndexSummary(
  params: Types.UseMarketIndexSummaryParams | null
): Types.UseMarketIndexSummaryResult {
  ...
  useEffect(() => {
    ...
    API.apiGet<Types.PaginatedResponse<unknown>>(API.marketIndexSummaryPath(), query)
      .then((res) => {
