...
export function useRelistings(params?: Types.PaginationParams): Types.UseRelistingsResult {
  ...
  useEffect(() => {
    ...
    API.apiGet<Types.PaginatedResponse<unknown>>(API.relistingPath(), query)
      .then((res) => {
