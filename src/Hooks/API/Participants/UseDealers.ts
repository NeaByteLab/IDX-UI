...
export function useDealers(params?: Types.PaginationParams): Types.UseDealersResult {
  ...
  useEffect(() => {
    ...
    API.apiGet<Types.PaginatedResponse<unknown>>(API.participantsDealersPath(), query)
      .then((res) => {
