...
export function useBrokers(params?: Types.PaginationParams): Types.UseBrokersResult {
  ...
  useEffect(() => {
    ...
    API.apiGet<Types.PaginatedResponse<unknown>>(API.participantsBrokersPath(), query)
      .then((res) => {
