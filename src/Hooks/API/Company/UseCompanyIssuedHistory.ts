...
export function useCompanyIssuedHistory(
  code: string | null,
  params?: Types.PaginationParams
): Types.UseCompanyIssuedHistoryResult {
  ...
  useEffect(() => {
    ...
    API.apiGet<Types.PaginatedResponse<unknown>>(API.companyIssuedHistoryPath(code), query)
      .then((res) => {
