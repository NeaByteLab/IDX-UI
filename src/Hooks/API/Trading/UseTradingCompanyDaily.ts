...
export function useTradingCompanyDaily(
  code: string | null,
  params?: Types.PaginationParams
): Types.UseTradingCompanyDailyResult {
  ...
  useEffect(() => {
    ...
    API.apiGet<Types.PaginatedResponse<unknown>>(API.tradingCompanyDailyPath(code), query)
      .then((res) => {
