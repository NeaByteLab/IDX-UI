...
export function useTradingSummary(params?: Types.PaginationParams): Types.UseTradingSummaryResult {
  ...
  useEffect(() => {
    ...
    API.apiGet<Types.PaginatedResponse<unknown>>(API.tradingSummaryPath(), query)
      .then((res) => {
